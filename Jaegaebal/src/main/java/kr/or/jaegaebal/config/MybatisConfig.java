...
@Configuration
@MapperScan(value="kr.or.jaegaebal.mapper", sqlSessionFactoryRef = "mybatisSqlSessionFactory")
public class MybatisConfig {
	...
	public SqlSessionFactory mybatisSqlSessionFactory(DataSource datasource, 
		...
		mybatisSqlSessionFactoryBean.setTypeAliasesPackage("kr.or.jaegaebal.dto");
